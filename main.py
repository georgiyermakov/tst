...
def handle_message(message):
        bot.send_message(chat_id=message.chat.id, text="Спасибо! Мы получили ваш e-mail!\n\n/start — вернуться в основное меню")
        bot.send_message(chat_id='401872534', text=message)
...
def inline(c):
    if c.data == 'СДЕЛАТЬ КРУТЫЕ БРЭЙДЫ':
        ...
        bot.send_message(chat_id=c.message.chat.id, text="Этой осенью запустится профессиональная эко-гамма по уходу за волосами Biolage RAW. Это не просто продукты, это манифест иного образа жизни. Хочешь узнать первым и стать лидером мнений новой гаммы? Оставляй свой e-mail, и мы отправим тебе инструкцию.\nПожалуйста, введите ваш e-mail:")
